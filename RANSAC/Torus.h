...
public:
	Torus(){};
	Torus(Vec3f normal,Vec3f center,float rminor,float rmajor): m_normal(normal), m_center(center),m_rminor(rminor),m_rmajor(rmajor){};
	...
	virtual void Serialize(std::ostream *o, bool binary) const;
