function d_U = signedDistanceFunc(pointIndex,unionOfCuboids,distances)
    ...
    for i = 1:numel(d_Cs)
        ...
        d_Cs(i) = min([
                ...
                (-1)*distances(pointIndex,unionOfCuboids(i,1)), ...
                distances(pointIndex,unionOfCuboids(i,2)), ...
                (-1)*distances(pointIndex,unionOfCuboids(i,2)), ...
                distances(pointIndex,unionOfCuboids(i,3)), ...
                (-1)*distances(pointIndex,unionOfCuboids(i,3)), ...
                distances(pointIndex,unionOfCuboids(i,4)), ...
                (-1)*distances(pointIndex,unionOfCuboids(i,4)), ...
                distances(pointIndex,unionOfCuboids(i,5)), ...
                (-1)*distances(pointIndex,unionOfCuboids(i,5)), ...
                distances(pointIndex,unionOfCuboids(i,6)), ...
                (-1)*distances(pointIndex,unionOfCuboids(i,6))
            ]);
    end
